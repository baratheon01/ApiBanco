        ...
        <div class="table-wrapper">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $cliente->create($nombre, $apellido, $direccion, $telefono, $fecha, $estado);
					if($res){
			...
			<div class="row">
				...
				<div class="col-md-6">
					<label>Fecha:</label>
					<input type="text" name="fechaingreso" id="fechaingreso" class='form-control' maxlength="64" required>
